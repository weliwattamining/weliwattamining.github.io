...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;color:rgba(0,0,0,.55);width:240px;height:160px;touch-action:pan-x pan-y}' +
    '.frame{position:absolute;inset:0;overflow:hidden;background:rgba(0,0,0,.04);touch-action:pan-x pan-y}' +
    ...
    ':host([data-reframe]) .frame{touch-action:none}' +
    ...
    '  cursor:pointer;user-select:none;touch-action:pan-x pan-y}' +
